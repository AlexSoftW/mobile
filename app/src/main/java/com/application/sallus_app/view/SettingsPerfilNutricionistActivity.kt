...
class SettingsPerfilNutricionistActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == Activity.RESULT_OK && data != null) {
            ...
            if (isFileSizeWithinLimit(selectedImageUri, 175)) {
                Glide.with(this).load(selectedImageUri).into(binding.fotoNutricionista)
                ...
                Glide.with(this).load(R.mipmap.default_profile).into(binding.fotoNutricionista)
    ...
    private fun setupView() {
        ...
        binding.constraintlayoutSettingsPerfilNutricionista.setOnClickListener {
            val galleryIntent =
    ...
    private fun setupObservers() {
        binding.btnSalvarAlteracao.setOnClickListener {
            ...
            if (selectedImageUri != Uri.EMPTY) {
                ...
                nutricionistViewModel.alterarFoto(dadosNutricionista.id, fotoPart)
            }
        ...
        nutricionistViewModel.responseEditarDadosNutricionistaBottomSheet.observe(this) {
