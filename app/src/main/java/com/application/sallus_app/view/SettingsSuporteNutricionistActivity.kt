...
import com.application.sallus_app.databinding.ActivitySettingsSuporteNutricionistaBinding

class SettingsSuporteNutricionistActivity : AppCompatActivity() {

    private lateinit var binding: ActivitySettingsSuporteNutricionistaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySettingsSuporteNutricionistaBinding.inflate(layoutInflater)
