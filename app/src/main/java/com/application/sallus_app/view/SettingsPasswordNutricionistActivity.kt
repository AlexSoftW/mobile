...
import com.application.sallus_app.databinding.ActivitySettingsPasswordNutricionistaBinding
...
class SettingsPasswordNutricionistActivity : AppCompatActivity() {

    private val nutricionistViewModel: NutritionistViewModel by viewModel()
    private lateinit var binding: ActivitySettingsPasswordNutricionistaBinding
    private lateinit var dadosNutricionista : NutritionistData;
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySettingsPasswordNutricionistaBinding.inflate(layoutInflater)
